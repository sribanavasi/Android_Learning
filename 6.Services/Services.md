...
**[JobIntentService](./IntentService and JobIntentService/IntentService_JobIntentService.md) as a replacement for IntentService that is compatible with newer versions of Android.**
